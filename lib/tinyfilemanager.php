...
$auth_users = array(
    'admin' => '$2y$10$nqhwLPgZOi7ygI61g3IiqOEQC8oR5H88Xqw3VWU6n0DYjM1U3rK7S',
    'james' => '$2y$10$rleJSs31Ze2azu1SJgyD0ezSbQgnYOMP7tW9yTr9TKvuArM65hsQa'
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'jpg,jpeg,mpeg,mp4,png';
...
//        $cmd = ($iswin) ? "for %F in (\"$file\") do @echo %~zF" : ($isdarwin ? "stat -f%z $arg" : "stat -c%s $arg");
        $cmd = ($iswin) ? "for %F in (\"$file\") do @echo %~zF" : ($isdarwin ? "stat -f%z $arg" : "stat -f%z $arg");
        @exec($cmd, $output);
